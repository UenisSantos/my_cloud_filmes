...
import 'package:myfilmes/modal_class/credits.dart';
import 'package:myfilmes/modal_class/function.dart';
import 'package:myfilmes/modal_class/genres.dart';
import 'package:myfilmes/modal_class/movie.dart';

import 'castncrew.dart';
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child:
                  Text('em cartaz', style: widget.themeData.textTheme.headline5),
            ),
          ],
        ),
        SizedBox(
    ...
    return Container(
      ...
      child: moviesList == null
          ...
          : moviesList!.length == 0
              ? Center(
                  child: Text(
                    "Ops! não consegui encontrar o filme",
                    style: widget.themeData!.textTheme.bodyText1,
                  ),
                )
              : ListView.builder(
